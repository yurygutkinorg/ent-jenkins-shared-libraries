...
String constrainLabelToSpecifications(String label) {
  // handling edge case. jenkins agent name is generated by truncating the pod label and appending a string
  // the truncated label leaves a trailing period
  // resulting agent name becomes invalid for e.g. jenkins-guardant-lims-data-service-lims-data-service-1.0.-gk5b1
  label = label.replace(".","-")
