...
def checkIfEnzymeService(String serviceName) {
  def serviceList = ["auth", "billing", "clinical", "curation", "exchange", "file", "finance", "ivd-reporting", "message", "misc", "omni-reporting", "problem-case", "iuo-reporting", "g360-reporting"]
